...
<label class="block text-sm p-2">
    ...
    <input name="{{$field->getName()}}" @isset($edit)  value="{{old($field->getName(),$edit->getOriginal($field->getName()))}}" @else value="{{old($field->getName(),$field->getDefaultValue())}}" @endisset

...
<label class="block text-sm p-2">
    ...
    <input type="file" name="{{$field->getName()}}" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="{{__($field->getTitle())}}">
    @isset($edit)
